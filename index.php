    ...
    <body>
        ...
        <section id="slider"><!--slider-->
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <img class="img-responsive" src="images/others/banner/b1.png" />
                        ...
                        <!--								<div class="col-sm-6">
                                                                                                <h1>MITA<span>NASH</span></h1>
                                                                                                <h2>Tu mejor elección</h2>
                                                                                                <p>Eligenos al momento de comprar, te damos la mejor calidad al mejor precio.</p>
                        ...
                        <!--                                                                <div class="col-sm-12">-->
                        <!--                                                                    <img class="img-responsive" src="images/others/banner/b1.png" style="width: 1000px;height: 315px;"/>-->
                        <!--								</div>-->
                        <!--</div>-->
                        <!--							<div class="item">
                                                                                        <div class="col-sm-6">
                ...
                <div class="features_items"><!--features_items-->
                    <ul>
                        <li style="display:inline">
                            <div class="fb-like" data-href="https://www.facebook.com/Mitanash" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
                        </li>
...
<script>(function (d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/es_LA/sdk.js#xfbml=1&appId=1499977076955260&version=v2.0";
